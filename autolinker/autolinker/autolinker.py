...
class AutoLinker:
  ...
  ... )
  >>> best_linker = autolinker.auto_link(
  ...
  def auto_link(self, data, attribute_columns, unique_id, comparison_size_limit, max_evals, cleaning="all", deterministic_columns=None, training_columns=None, threshold=0.9):
    ...
    # Train best linker
    self.best_linker, self.best_predictions = self.train_linker(data, self.best_params, attribute_columns, unique_id, self.deterministic_columns, self.training_columns)
